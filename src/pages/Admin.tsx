        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="col-span-1 md:col-span-2 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">Tiêu đề phần thành tích</label>
                <input type="text" value={candidate.introTitle || ''} onChange={e => handleCandidateChange('introTitle', e.target.value)} className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none mb-2" />
